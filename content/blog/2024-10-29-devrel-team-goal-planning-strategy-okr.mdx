...
author: "[Brendan Graetz](https://x.com/intent/user?screen_name=bguiz)"
authorImage: "https://github.com/bguiz.png"
date: 2024-10-29
keywords: ["Strategy & Planning", "Metrics & Analytics", "Leadership"]
---

import { Step, Steps } from 'fumadocs-ui/components/steps';
import { Accordion, Accordions } from 'fumadocs-ui/components/accordion';
import { Card, Cards } from '@/components/card';
import { PenTool, Lightbulb, Target, Users, Code, CheckSquare } from 'lucide-react';

![](https://blog.bguiz.com/images/posts/devrel-team-okr-planning-strategy--banner.png)
...
<Cards>
  <Card
    ...
    title="The OKRA Framework"
  >
    This article introduces you to the OKRA framework - a method for planning *Objectives and Key Results* (OKRs) for your team. The additional "A" is for emphasis on *actions*. This framework is the result of about 5 years of iteration.
  </Card>

  <Card
    icon={<PenTool className="text-purple-300" />}
    title="Hands-on Approach"
  >
    It is a hands-on, spreadsheet-centric approach to planning that can be applied to any team that uses OKRs - and this article draws from specific examples that relate to DevRel teams.
  </Card>
  ...
  <Card
    ...
    title="Strategy & Tips"
  >
    We will round off with goal setting tips, and strategies to plan and execute them well. Time to plan your team's goals effectively!
  </Card>
</Cards>
...
![OKRA spreadsheet - completed example for a hypothetical DevRel team](https://blog.bguiz.com/images/posts/devrel-team-okr-planning-strategy--completed-okra-spreadsheet.png)
...
<Accordions>
  <Accordion title="Group 1: Goals">
    - *Objectives*: The goals 
    - *Key Results (KRs)*: Metrics for the goals
    - *Type*: Lead or lag
  </Accordion>

  <Accordion title="Group 2: Metrics">
  ...
  <Accordion title="Group 3: Actions">
  ...
  <Accordion title="Group 4: Definitions">
  ...
  <Accordion title="Group 5: Resourcing">
  ...
  <Accordion title="Group 6: Timeline">
...
<Cards>
  <Card
    ...
    title="Design of KRs"
  >
    How to structure and define your Key Results effectively
  </Card>
  ...
  <Card
    ...
    title="Resourcing"
  >
    Managing team resources and allocation
  </Card>

  <Card
    icon={<Code className="text-purple-300" />}
    title="Wider Integration"
  >
    How your goals fit into the broader organization
  </Card>
</Cards>
...
<Steps>
<Step>
OKRs from the current or previous OKR cycles
</Step>

<Step>
A brainstorm on new ideas
</Step>

<Step>
The wider organisational metrics
</Step>

<Step>
Resourcing availability during that time period.
</Step>
</Steps>
...
<Steps>
<Step>
Hold a retrospective meeting. What went well, and what did not, in the previous planning cycle? What does the team think it should start doing, and stop doing, in the next cycle?
</Step>

<Step>
Hold a kick-off meeting. Explain the exercise - either for the first time, or a recap. Conduct a brainstorm.
</Step>

<Step>
Make a copy of the spreadsheet from the template, and share edit access with the team.
</Step>

<Step>
Task each team member to come up with between 3 to 5 KRs, asynchronously. The team may already have assigned DevRel sub-function areas. For example, Developer Marketing, Developer Education, Developer Success. If so, each member should focus on their dedicated areas.
</Step>

<Step>
Hold a finalisation meeting. The team discusses the pros and cons of each KR and decides what to keep, change, or delete. Importantly, all KRs must have no ambiguity (especially TODOs).
</Step>
</Steps>
...
Or reply to the [tweet about this article](https://x.com/devreldirectory/status/1851247000693379294).
...
This article was originally posted on [blog.bguiz.com](https://blog.bguiz.com/2024/devrel-team-okr-planning-strategy/).
